  ...
  return (
    <Float speed={1.5} rotationIntensity={0.6} floatIntensity={1}>
      <Torus ref={meshRef} args={[0.8, 0.25, 32, 64]} position={[-2.5, 1.5, -2]}>
        <meshStandardMaterial color="#d4956a" roughness={0.3} metalness={0.6} />
      </Torus>
    </Float>
  );
};
  ...
  return (
    <Float speed={1.8} rotationIntensity={0.5} floatIntensity={1.2}>
      <Box ref={meshRef} args={[0.6, 0.6, 0.6]} position={[2.2, -1.2, -1]}>
        <meshStandardMaterial color="#1a2340" roughness={0.4} metalness={0.7} />
      </Box>
    </Float>
  );
};
...
const Particles = () => {
  ...
  return (
    <points ref={ref}>
      ...
      <pointsMaterial size={0.04} color="#e07030" transparent opacity={0.6} sizeAttenuation />
    </points>
  );
};
  ...
  return (
    <div className="absolute inset-0 z-0">
      <Canvas camera={{ position: [0, 0, 5], fov: 50 }} dpr={[1, 1.5]}>
        ...
        <directionalLight position={[5, 5, 5]} intensity={1} color="#fff5ee" />
        <pointLight position={[-3, -3, 2]} intensity={0.5} color="#e07030" />
        <AnimatedSphere />
        <FloatingTorus />
        <FloatingBox />
        <Particles />
